...
class LibraryViewModel extends ChangeNotifier {
  ...
  List<LibraryItemData> songAndArtist = [];
  ...
  void fetchSong() async {
    ...
    try {
      ...
      data = AsyncValue.success(songAndArtist);
    } catch (e) {
  ...
  void increaseLike(String songId) async {
    try {
      await songRepository.increaseLike(songId);

      songAndArtist = songAndArtist.map((item) {
